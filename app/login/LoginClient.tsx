...
const LoginClient = () => {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      setIsLoading(false);
      toast({
        title: "Sikeres bejelentkezés! (demo)",
        description: "Átirányítás a dashboardra...",
      });
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast({
        title: "Google bejelentkezés sikertelen",
        ...
        <Card className="shadow-lg border-border/50 bg-card/95 backdrop-blur">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center">
              Jelentkezz be AquilaHire fiókodba
            </CardTitle>
            <CardDescription className="text-center">
              Folytasd az AI alapú interjúgyakorlást ott, ahol abbahagytad
            </CardDescription>
          </CardHeader>
