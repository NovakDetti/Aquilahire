...
const InterviewReport = ({ params }: InterviewReportPageProps) => {
  const { id } = params;
  ...
  const report = {
    ...
    overallScore: 82,
    overallSummary:
      "Összességében jó teljesítményt nyújtottál. Erős technikai tudás, de a kommunikációs készségeiden érdemes dolgozni.",
    strengths: [
    ...
    questions: [
      {
        ...
        answerText:
          "Általános bemutatkozás, tapasztalatok felsorolása...",
        score: 4,
        shortFeedback:
          "Jó bemutatkozás, de lehetett volna specifikusabb a motivációval kapcsolatban.",
      },
      {
        id: "q2",
        order: 2,
        ...
        answerText:
          "E-commerce platform fejlesztése React és TypeScript használatával...",
        score: 5,
        shortFeedback:
          "Kiváló részletességű válasz konkrét példákkal és eredményekkel.",
      },
      {
        id: "q3",
        order: 3,
        ...
        answerText:
          "Performance problémák megoldása egy nagy alkalmazásban...",
        score: 4,
        shortFeedback:
          "Jó példa, de lehetett volna több technikai részlet a megoldásról.",
      },
      {
        id: "q4",
        order: 4,
        ...
        answerText:
          "Folyamatos tanulás, online kurzusok, community részvétel...",
        score: 3,
        shortFeedback:
          "Általános válasz, specifikusabb forrásokat és projekteket említhettél volna.",
      },
      {
        id: "q5",
        order: 5,
        ...
        answerText:
          "Csapatprojekt egyetemen, együttműködés tapasztalatok...",
        score: 3,
        shortFeedback:
          "Jó kezdés, de több konkrétumot adhattál volna a saját szerepedről.",
      },
    ],
  };
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <Card className="relative overflow-hidden border-0 shadow-2xl">
          ...
          <div className="absolute inset-0">
            ...
            <div
              className="absolute bottom-10 left-10 w-80 h-80 bg-white/10 rounded-full blur-3xl floating"
          ...
          >
            <ul className="space-y-3">
              {report.weaknesses.map((weakness, index) => (
                <li
                  key={index}
                  className="flex items-start gap-3 p-3 rounded-lg bg-warning/5 hover:bg-warning/10 transition-colors"
                >
        ...
        >
          <ul className="space-y-4">
            {report.practiceRecommendations.map((recommendation, index) => (
              <li
                key={index}
                className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-primary/5 to-cyan/5 border border-primary/10 hover:border-primary/30 transition-colors"
              >
        ...
        <Card className="relative overflow-hidden border-2 border-primary">
          ...
          <CardContent className="relative z-10 py-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-md mx-auto">
              Gyakorold tovább, és javíts a pontszámodon! Minden interjú
              közelebb visz a céljaidhoz.
            </p>
            <Button
              asChild
              size="lg"
              className="shadow-primary h-14 px-8 text-base"
            >
